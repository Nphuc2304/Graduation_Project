    ...
    return (
      <TouchableOpacity style={styles.itemDanhMuc}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.textS} numberOfLines={2} ellipsizeMode="tail">
          {item.name}
        </Text>
      </TouchableOpacity>
    );
  ...
  const renderFilter = ({ item, index }: any) => {
    return (
      <TouchableOpacity onPress={() => setFilterIndex(index)}>
        <Text
          style={[styles.textS, index == filterIndex && { color: "#2B78C0" }]}
        >
          {item.name}
        </Text>
      </TouchableOpacity>
        ...
        >
          ...
          >
            ...
            <Image
              ...
              style={{ width: 15, height: 13, tintColor: "#FED640" }}
            />{" "}
            | Đã bán {item.bought}
          </Text>
          <View
          ...
          >
            <Image
              source={require("@/assets/icons/haft-sun.png")}
  ...
  return (
    <ScrollView style={{ flex: 1 }}>
      <View style={styles.categoriesContainer}>
        <Text style={[styles.textM, { marginTop: 10, marginBottom: 5 }]}>
        ...
        <TouchableOpacity onPress={() => setShowDanhMuc(!showDanhMuc)}>
          <Text
            style={[
              styles.textM,
              { textAlign: "center", marginTop: 10, color: "#2B78C0" },
            ]}
          >
            {showDanhMuc ? "Thu gọn" : "Xem Thêm Các Danh Mục Khác"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={{ padding: 10 }}>
        <FlashList data={product} renderItem={renderProd} numColumns={2} />
      </View>
    </ScrollView>
  );
};
